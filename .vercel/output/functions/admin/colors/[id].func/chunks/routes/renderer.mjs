import { a as useRuntimeConfig, e as encodePath, j as joinRelativeURL, d as defineRenderHandler, b as getQuery, c as createError, f as destr, h as getRouteRules, i as joinURL, k as getResponseStatusText, l as getResponseStatus, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"المتجر الإلكتروني الأول للأجهزة الكهربائية في جدة. تسوق أحدث المنتجات بأفضل الأسعار."},{"property":"og:title","content":"أسوار جدة | Aswar Jeddah"},{"property":"og:description","content":"المتجر الإلكتروني الأول للأجهزة الكهربائية في جدة. تسوق أحدث المنتجات بأفضل الأسعار."},{"property":"og:type","content":"website"},{"property":"og:locale","content":"ar_SA"},{"name":"theme-color","content":"#0B0E28"}],"link":[{"rel":"icon","type":"image/png","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"}],"style":[],"script":[],"noscript":[],"titleTemplate":"%s","title":"أسوار جدة | Aswar Jeddah - متجر الأجهزة الكهربائية الأول","htmlAttrs":{"dir":"rtl","lang":"ar"}};
...
const getServerEntry = () => import('../virtual/entry.mjs').then(function (n) { return n.q; }).then((r) => r.default || r);
...
const entryFileName = "DaY5lVoz.js";
