...
//#region pages/admin/colors/create.vue?vue&type=script&setup=true&lang.ts
var create_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "create",
	__ssrInlineRender: true,
	setup(__props) {
		useHead$1({ title: "إضافة لون جديد | لوحة التحكم" });
		const { submitForm, isSubmitting } = useAdminColors();
		const handleCreate = async (payload) => {
			if (await submitForm(payload, false)) navigateTo("/admin/colors");
		};
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div><h1 class="text-2xl font-black text-slate-900">إضافة لون جديد (POST FormData)</h1><p class="text-xs sm:text-sm text-slate-500 mt-1 font-medium"> أدخل بيانات اللون وحدد نوعه (كود Hex أو صورة نقشة/خامة) لإضافته لخيارات المتجر. </p></div></div>`);
...
//#endregion
//#region pages/admin/colors/create.vue
...
create_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/colors/create.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var create_default = create_vue_vue_type_script_setup_true_lang_default;

export { create_default as default };
//# sourceMappingURL=create-D7uqEKEX.mjs.map
