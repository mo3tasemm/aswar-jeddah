...
//#region pages/admin/staff/[id]/index.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region pages/admin/staff/[id]/index.vue
var _sfc_setup = index_vue_vue_type_script_setup_true_lang_default.setup;
index_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/staff/[id]/index.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var _id__default = index_vue_vue_type_script_setup_true_lang_default;

export { _id__default as default };
//# sourceMappingURL=_id_-C9XstMoh.mjs.map
