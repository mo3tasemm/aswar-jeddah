...
//#region pages/admin/staff/[id].vue?vue&type=script&setup=true&lang.ts
var _id__vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "[id]",
	__ssrInlineRender: true,
	setup(__props) {
		useRoute();
		const { isLoadingAdmins} = useAdminRolesAndAdmins();
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			else if (currentAdmin.value) _push(ssrRenderComponent(StaffForm_default, { "initial-data": currentAdmin.value }, null, _parent));
			else {
...
//#endregion
//#region pages/admin/staff/[id].vue
...
_id__vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/staff/[id].vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var _id__default = _id__vue_vue_type_script_setup_true_lang_default;

export { _id__default as default };
//# sourceMappingURL=_id_-Br-a7-fc.mjs.map
