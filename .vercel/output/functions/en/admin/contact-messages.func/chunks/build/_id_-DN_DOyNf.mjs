...
//#region pages/admin/products/[id].vue?vue&type=script&setup=true&lang.ts
var _id__vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "[id]",
	__ssrInlineRender: true,
	setup(__props) {
		useHead$1({ title: "تعديل المنتج | لوحة التحكم" });
		...
		const handleUpdate = async (payload) => {
			if (await submitForm(payload, true, productId)) navigateTo("/admin/products");
		};
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div><h1 class="text-2xl font-black text-slate-900">تعديل المنتج (ID: ${ssrInterpolate(unref(route).params.id)})</h1><p class="text-xs sm:text-sm text-slate-500 mt-1 font-medium">تحديث بيانات المنتج وتعديل خصائصه عبر API التحديث (POST FormData).</p></div></div>`);
			if (loading.value) _push(`<div class="flex flex-col items-center justify-center py-20 text-amber-500 gap-4"><div class="w-10 h-10 border-4 border-amber-400 border-t-transparent rounded-full animate-spin"></div><span class="font-extrabold text-sm text-slate-700">جاري جلب بيانات المنتج من السيرفر...</span></div>`);
			else _push(ssrRenderComponent(ProductFormAdvanced_default, {
				"is-edit-mode": true,
				"initial-data": productData.value,
...
//#endregion
//#region pages/admin/products/[id].vue
...
//# sourceMappingURL=_id_-DN_DOyNf.mjs.map
