...
//#region pages/admin/brands/[id].vue?vue&type=script&setup=true&lang.ts
var _id__vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "[id]",
	__ssrInlineRender: true,
	setup(__props) {
		useHead$1({ title: "تعديل العلامة التجارية | لوحة التحكم" });
		...
		const handleUpdate = async (payload) => {
			if (await submitForm(payload, true, brandId)) navigateTo("/admin/brands");
		};
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div><h1 class="text-2xl font-black text-slate-900">تعديل العلامة التجارية (ID: ${ssrInterpolate(unref(route).params.id)})</h1><p class="text-xs sm:text-sm text-slate-500 mt-1 font-medium">تحديث بيانات البراند وشعاره عبر API التحديث (POST FormData).</p></div></div>`);
			if (loading.value) _push(`<div class="flex flex-col items-center justify-center py-20 text-amber-500 gap-4"><div class="w-10 h-10 border-4 border-amber-400 border-t-transparent rounded-full animate-spin"></div><span class="font-extrabold text-sm text-slate-700">جاري جلب بيانات البراند من السيرفر...</span></div>`);
			else _push(ssrRenderComponent(BrandFormAdvanced_default, {
				"is-edit-mode": true,
				"initial-data": brandData.value,
				"is-submitting": unref(isSubmitting),
				onSubmit: handleUpdate,
				onCancel: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("/admin/brands")
			}, null, _parent));
			_push(`</div>`);
		};
	}
...
//#endregion
//#region pages/admin/brands/[id].vue
...
_id__vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/brands/[id].vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var _id__default = _id__vue_vue_type_script_setup_true_lang_default;

export { _id__default as default };
//# sourceMappingURL=_id_-CHN_-O2t.mjs.map
