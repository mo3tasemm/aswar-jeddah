...
//#region components/dashboard/ui/StatusBadge.vue?vue&type=script&setup=true&lang.ts
var StatusBadge_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		const isAr = computed(() => {
			return (locale?.value || adminLanguage?.value || "ar") === "ar";
		});
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<span${ssrRenderAttrs(mergeProps({ class: ["inline-flex items-center justify-center gap-1.5 px-3 py-1 rounded-full text-xs font-black tracking-wide shrink-0 transition-colors", colorClasses.value] }, _attrs))}><span class="${ssrRenderClass([dotColorClass.value, "w-2 h-2 rounded-full shrink-0"])}"></span><span>${ssrInterpolate(statusLabel.value)}</span></span>`);
		};
	}
});
//#endregion
//#region components/dashboard/ui/StatusBadge.vue
var _sfc_setup = StatusBadge_vue_vue_type_script_setup_true_lang_default.setup;
StatusBadge_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dashboard/ui/StatusBadge.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var StatusBadge_default = Object.assign(StatusBadge_vue_vue_type_script_setup_true_lang_default, { __name: "DashboardUiStatusBadge" });

export { StatusBadge_default as S };
//# sourceMappingURL=StatusBadge-klet5TK_.mjs.map
