import { t as edit_default$1 } from './edit-DVBaTPL2.mjs';
...
//#region pages/admin/admins/[id]/edit.vue?vue&type=script&setup=true&lang.ts
var edit_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "edit",
	__ssrInlineRender: true,
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(edit_default$1, _attrs, null, _parent));
		};
	}
});
//#endregion
//#region pages/admin/admins/[id]/edit.vue
...
edit_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/admins/[id]/edit.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var edit_default = edit_vue_vue_type_script_setup_true_lang_default;

export { edit_default as default };
//# sourceMappingURL=edit-DQRu5DfX.mjs.map
