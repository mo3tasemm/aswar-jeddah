...
//#region pages/admin/staff/create.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region pages/admin/staff/create.vue
...
create_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/staff/create.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var create_default = create_vue_vue_type_script_setup_true_lang_default;

export { create_default as default };
//# sourceMappingURL=create-t4eY_pbr.mjs.map
