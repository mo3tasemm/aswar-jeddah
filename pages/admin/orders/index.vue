            ...
            <tr v-for="order in filteredOrders" :key="order.id" class="hover:bg-slate-50/50 transition-colors group">
              ...
              <td class="px-6 py-4">
                <div class="flex items-center justify-center">
                  <NuxtLink :to="`/admin/orders/${order.id}`" class="px-3 py-1.5 rounded-lg bg-indigo-50 text-indigo-600 hover:bg-indigo-600 hover:text-white text-xs font-bold transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100 flex items-center gap-1">
                    التفاصيل
