<template>
  <div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
      ...
      <NuxtLink to="/dashboard/coupons/create" class="inline-flex items-center justify-center px-4 py-2.5 rounded-xl bg-indigo-600 text-white font-bold hover:bg-indigo-700 transition-colors shadow-sm gap-2">
            ...
            <tr v-for="coupon in filteredCoupons" :key="coupon.id" class="hover:bg-slate-50/50 transition-colors group">
              ...
              <td class="px-6 py-4">
                <div class="flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                  <NuxtLink :to="`/dashboard/coupons/${coupon.id}`" class="p-2 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors" title="تعديل الكوبون">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
